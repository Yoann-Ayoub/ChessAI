...
public class UCI {
    ...
    public static void inputGo() {
        ...
        int index=(int)(Math.floor(Math.random()*(move.length()/4))*4); // juste pour tester pour le moment ne cherche pass le meilleur mouvement mais un mouvement aléatoire
